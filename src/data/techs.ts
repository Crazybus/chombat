...
export const techs: Record<string, TechData> = {
  ...
  curare: {
    ...
    effects: [
      { type: 4, attribute: 25, value: 1541, unitId: 4, class: -1 },
      { type: 4, attribute: 25, value: 1541, unitId: 2579, class: -1 },
      { type: 4, attribute: 25, value: 1541, unitId: 464, class: -1 },
      { type: 4, attribute: 25, value: 1538, unitId: 2581, class: -1 },
      { type: 4, attribute: 25, value: 1538, unitId: 1896, class: -1 },
    ],
    age: 4,
    civ: 59,
  },
