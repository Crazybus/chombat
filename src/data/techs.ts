...
export const techs: Record<string, TechData> = {
  ...
  castle_barracks_tech_requirementype: {
  ...
  castle_eco_tech_requirementype: {
  ...
  feudal_eco_tech_requirementype: {
  ...
  fourth_change_of_governmentype: {
  ...
  gold_shaft_mining_requirementype: {
  ...
  imperial_eco_tech_requirementype: {
  ...
  siege_engineers_requirementype: {
  ...
  second_change_of_governmentype: {
  ...
  shadow_node_mule_cart_settlementype: {
  ...
  stone_shaft_mining_requirementype: {
  ...
  two_handed_swordsman_requirementype: {
