    ...
    <>
        ...
        <div className="nav-content">
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            ...
            <a href="/" className="nav-brand">
              ...
              <span className="brand-text">CHOMBAT <span className="brand-version">(alpha)</span></span>
            </a>
          </div>
          ...
          <div className="nav-actions">
            ...
            <div style={{ display: 'flex', gap: '5px' }}>
              <button className="nav-btn secondary hide-mobile" onClick={handleExport}>Export</button>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="sidebar-links">
          ...
          <li><a href="https://discord.gg/UZ7mxjzNhf" target="_blank" rel="noreferrer" className="sidebar-social">Discord</a></li>
          <li><a href="https://github.com/Crazybus/chombat" target="_blank" rel="noreferrer" className="sidebar-social">GitHub</a></li>
        </ul>
      </div>

      <main id="units" className="section-anchor">
        <ScenariosBar />
