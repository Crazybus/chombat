    ...
    return (
        <>
            <nav className="sticky-nav">
                <div className="nav-content">
                    ...
                    <div className="nav-actions">
                        <div className="social-links" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginRight: '15px' }}>
                            ...
                            <button className="nav-icon-btn" title="Toggle Light/Dark Mode" onClick={() => setIsDarkMode(!isDarkMode)}>🌓</button>
                        </div>
                        <button className="nav-btn secondary hide-mobile" style={{ marginRight: '8px' }} onClick={handleExport}>Export</button>
            ...
            <main>
                ...
                <div id="units" className="simulation-container section-anchor">
                    <ArmyPanel army="a" />
                    <ArmyPanel army="b" />
                </div>
