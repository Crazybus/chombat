                  ...
                  <tbody>
                    {res1vX.table.map((row: any, i: number) => (
                      <tr key={i} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', background: i % 2 === 0 ? 'rgba(255,255,255,0.02)' : 'transparent' }}>
                        ...
                        <td style={{ padding: '6px 8px', color: row.winA ? 'var(--army-a-color)' : 'var(--army-b-color)', fontWeight: 'bold' }}>
                          {row.winner} <span style={{ opacity: 0.7, fontWeight: 'normal', fontSize: '0.75rem' }}>[{row.pct}%]</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>
